...
def render_graph_UnifiedRichVXL():
    ...
    VBNLShadingPass = createPass('VBNLShadingPass', {'shortDistance': 0.0, 'shortDistanceRange': 0.0, 'MaxPathIntensity': 0.0, 'BounceNum': 256, 'VirtualLightUseNEE': True, 'EnablePreciseVirtualLightNEE': False, 'VirtualLightUseMIS': False, 'RoughnessThreshold': 0.11999999731779099, 'UseRIS': False, 'NEESamples': 1, 'enableSpatialResampling': False, 'enableTemporalResampling': False, 'shadingMode': 2, 'MISWithPowerSampling': False, 'FinalMISWithPowerSampling': False, 'ShadingNormalCheck': True, 'ShadingMaterialCheck': False, 'UseTraditionalVXL': True, 'UseRichVXL': True, 'UseVSL': True})
    ...
    g.addEdge('RelaxationPass.output', 'VBNLShadingPass.input')
